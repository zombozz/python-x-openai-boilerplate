...
def verify_openai_key():
    ...
    try:
        ...
        log_message("OpenAI keys verified and response OK")
        return True
    except Exception as e:
        log_message(f"An error occurred in verifying OpenAI API: {e}")
        return False
...
def get_reply(openai_client, message_to_ai, ai_rules):
    try:
        ...
        log_message(f"Error in OpenAI get_reply function: {e}")
        return 0